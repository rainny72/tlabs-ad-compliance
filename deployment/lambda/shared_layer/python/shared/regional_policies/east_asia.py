...
EAST_ASIA_POLICY = RegionalPolicy(
    ...
    policies={
        PolicyCategory.HATE_HARASSMENT: RegionalPolicyEntry(
            ...
            sub_rules=[
                SubCategoryRule(
                    ...
                    description="Ethnic/national discrimination — CN: criminal offence",
        ...
        PolicyCategory.PROFANITY_EXPLICIT: RegionalPolicyEntry(
            ...
            notes="EA is strictest region for profanity; CN NRTA 'vulgar content' ban is very broad",
        ),
        PolicyCategory.DRUGS_ILLEGAL: RegionalPolicyEntry(
            ...
            notes="All 3 countries: zero tolerance for drug content",
        ),
        PolicyCategory.UNSAFE_MISLEADING_USAGE: RegionalPolicyEntry(
            ...
            notes="CN 2021: all imported cosmetics must be registered",
        ),
        PolicyCategory.MEDICAL_COSMETIC_CLAIMS: RegionalPolicyEntry(
            ...
            sub_rules=[
                ...
                SubCategoryRule(
                    ...
                    description="CN: absolute expressions banned",
                    severity=Severity.CRITICAL,
                ...
                SubCategoryRule(
                    ...
                    description="CN 2021: cosmeceutical term explicitly banned",
                    severity=Severity.HIGH,
                ...
                SubCategoryRule(
                    ...
                    description="KR: functional cosmetic requiring separate approval",
                    severity=Severity.MEDIUM,
            ...
            notes="CN: strictest — no absolute terms, no medical terms; KR: functional cosmetics need MFDS approval",
        ),
        PolicyCategory.DISCLOSURE: RegionalPolicyEntry(
            ...
            sub_rules=[
                SubCategoryRule(
                    name="kr_hidden_ad",
                    description="KR hidden ad regulation",
                    severity=Severity.MEDIUM,
                ...
                SubCategoryRule(
                    ...
                    description="JP stealth marketing regulation (2023.10~)",
                    severity=Severity.MEDIUM,
            ...
            notes="KR: KFTC fines; JP: stealth marketing ban effective Oct 2023; CN: Ad Law Art.14",
        ),
    },
)
